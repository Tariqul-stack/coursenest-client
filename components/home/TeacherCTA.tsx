          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-4 leading-relaxed">
                ...
                your first course today and start building your passive income
                stream.
              </p>
              <Link
            ...
            <div className="flex flex-col gap-5">
              {benefits.map((benefit, index) => (
                <motion.div
                  ...
                  className="flex items-start gap-4 bg-white bg-opacity-5 border border-white border-opacity-10 rounded-2xl p-5"
                >
                  <div className="w-12 h-12 bg-[#e94560] bg-opacity-20 rounded-xl flex items-center justify-center shrink-0">
                    <benefit.icon size={22} color="#e94560" />
                  </div>
                  <div>
